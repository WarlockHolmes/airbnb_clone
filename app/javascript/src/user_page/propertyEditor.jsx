...
export const BookingsViewer = (props) => {
...
//Input Sections of Editor
class BasicInfo extends React.Component {

  render () {
    const {title, property_type, change, description, price_per_night, city, country} = this.props;
...
class AmenitiesRow extends React.Component {
  render() {

    const {change, beds, baths, bedrooms, tv, internet, kitchen, hair_dryer, parking, laundry, enhanced_clean, addAmenity, save, petRef} = this.props;
...
class PetCheckbox extends React.Component {

  render () {
    const { dogs, cats, other, small, hypoallergenic, outdoor, petForm } = this.props;
...
class PetInputs extends React.Component {

  render () {
    const { pets, dogs, cats, other, small, hypoallergenic, outdoor, pet_notes, petForm, petRef} = this.props;
...
class PoliciesRow extends React.Component {

  render() {
    const {change, max_guests, enhanced_clean, parties, pets, smoking, dogs, cats, other, small, hypoallergenic, outdoor, pet_notes, petForm, petRef} = this.props;
...
//All Inputs
class PropertyInputs extends React.Component {

  render() {
    const {title, property_type, change, description, price_per_night, max_guests, city, country, beds, baths, bedrooms, tv, internet, kitchen, parties, pets, smoking, dogs, cats, other, small, hypoallergenic, outdoor, pet_notes, petForm, notes, hair_dryer, parking, laundry, enhanced_clean, addAmenity, save, petRef} = this.props;

    const AddAmenitySelect = () => {
    ...
    return(<React.Fragment>
        <BasicInfo
          title={title} description={description} price_per_night={price_per_night} property_type={property_type} city={city} country={country} change={change}
        />
        <hr/>
        <AmenitiesRow
        baths={baths} bedrooms={bedrooms} beds={beds} parking={parking} enhanced_clean={enhanced_clean} parties={parties} smoking={smoking} laundry={laundry} internet={internet} tv={tv} kitchen={kitchen} hair_dryer={hair_dryer} change={change}
        />
        <hr/>
        <PoliciesRow pets={pets} max_guests={max_guests} enhanced_clean={enhanced_clean} parties={parties} smoking={smoking} dogs={dogs} cats={cats} other={other} small={small} hypoallergenic={hypoallergenic} outdoor={outdoor} pet_notes={pet_notes} petForm={petForm} change={change} petRef={this.petRef}/>
        <hr/>
        <AdditionalNotes/>
        <AddAmenitySelect/>
